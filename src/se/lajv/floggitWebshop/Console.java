...
import se.lajv.floggitWebshop.Service.StockService;
...
public class Console {
	...
	public void ConsoleAdminOrder(String username, String password) {
	...
	public void ConsoleAdminStock(String username, String password) {
		Menus.AdminStockMenu();
		int costumerMenuChoice = input.nextInt();
		input.nextLine();
		switch (costumerMenuChoice) {
		case 1:
			stock.getAll(username, password);
			break;
		case 2:
			stock.getLessThen(username, password);
			break;
		case 3:
			break;
		}
	...
	public void ConsoleCustomerProd(String username, String password,
			String email) {

		username = "userdummy";
		password = "1234";

		prod.getCustomer(username, password, email);
	...
	public void ConsoleCustomerCart(String username, String password,
			String email) {
		...
		switch (cartChoice) {
		case 1:
			cart.get(username, password, email);
			break;
		case 2:
